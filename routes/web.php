...
Route::get('tttee', function(){
  Mail::to('emac@gmail.com')->send(new NewUserRegistration('mee'));
});


Route::get('/vendors/africa','Front\VendorController@africa')->name('vendors.africa');
Route::get('/vendors/foreign','Front\VendorController@foreign')->name('vendors.foreign');
...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/agent/secret/login/{id}', 'Admin\AgentController@secret')->name('admin-agent-secret');
  ...
  Route::get('/agents/withdraws/datatables', 'Admin\AgentController@withdrawdatatables')->name('admin-agent-withdraw-datatables'); //JSON REQUEST
  Route::get('/agents/withdraws', 'Admin\AgentController@withdraws')->name('admin-agent-withdraw-index');
  Route::get('/agents/withdraw/{id}/show', 'Admin\AgentController@withdrawdetails')->name('admin-agent-withdraw-show');
  Route::get('/agents/withdraws/accept/{id}', 'Admin\AgentController@accept')->name('admin-agent-withdraw-accept');
  Route::get('/agents/withdraws/reject/{id}', 'Admin\AgentController@reject')->name('admin-agent-withdraw-reject');
...
// Verification Section Ends
  ...
  Route::get('/market/datatables', 'Admin\MarketController@datatables')->name('admin-market-datatables'); //JSON REQUEST
  Route::get('/market', 'Admin\MarketController@index')->name('admin-market-index');
  Route::get('/market/create', 'Admin\MarketController@create')->name('admin-market-create');
  Route::post('/market/create', 'Admin\MarketController@store')->name('admin-market-store');
  Route::get('/market/edit/{id}', 'Admin\MarketController@edit')->name('admin-market-edit');
  Route::post('/market/edit/{id}', 'Admin\MarketController@update')->name('admin-market-update');
  Route::get('/market/delete/{id}', 'Admin\MarketController@destroy')->name('admin-market-delete');
  Route::get('/market/status/{id1}/{id2}', 'Admin\MarketController@status')->name('admin-market-status');
  Route::get('/load/market/{id}/', 'Admin\MarketController@load')->name('admin-market-load'); //JSON REQUEST
  Route::get('/child-markets/{id}/', 'Admin\MarketController@child_markets')->name('admin-child-markets'); //JSON REQUEST
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::group(['middleware'=>'vendor'], function(){
    Route::get('/advert', 'Admin\AdvertController@index')->name('admin-advert-index');
    Route::get('/advert/toggle-status/{id}', 'Admin\AdvertController@toggle_status')->name('admin-toggle-status');
  });
  
  // Route::get('/advert/edit/{id}', 'Admin\AdvertController@edit')->name('admin-advert-edit');
  // Route::post('/advert/edit/{id}', 'Admin\AdvertController@update')->name('admin-advert-update');
  // Route::get('/advert/delete/{id}', 'Admin\AdvertController@destroy')->name('admin-advert-delete');
  // Route::get('/advert/status/{id1}/{id2}', 'Admin\AdvertController@status')->name('admin-advert-status');
...
Route::prefix('user')->group(function() {
  ...
  Route::post('/become-an-agent', 'Agent\AgentController@become_an_agent');
  ...
  // adverts
  // Route::get('/affilate/code', 'User\WithdrawController@affilate_code')->name('user-affilate-code');
  Route::get('/adverts', 'User\AdvertController@index')->name('user-adverts');
  Route::get('/adverts/create', 'User\AdvertController@create')->name('user-advert-create');
  Route::post('/adverts/create', 'User\AdvertController@store')->name('user-advert-store');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/child-markets/{id}/', 'Vendor\ProductController@child_markets')->name('vendor-child-markets');


  // manufacturer chat
  Route::get('chats',"Vendor\ChatController@index");
  Route::get('replies/{id}',"Vendor\ChatController@show_chat_replies");
  Route::post('/chat/new_chat','Vendor\ChatController@new_chat')->name('chat.new');
  Route::post('/chat/replies','Vendor\ChatController@chat_replies')->name('chat.replies');
  Route::post('/chat/reply','Vendor\ChatController@reply')->name('chat.reply');
  Route::post('/chat/continue','Vendor\ChatController@continue')->name('chat.continue');
  ...
  //GALLERY SECTION
  Route::get('/gallery/image', 'Vendor\GalleryController@image_index')->name('vendor-gallery-image-index');
  Route::get('/gallery/video', 'Vendor\GalleryController@video_index')->name('vendor-gallery-video-index');

  Route::post('/gallery/image', 'Vendor\GalleryController@image_store')->name('vendor-gallery-image-store');
  Route::post('/gallery/video', 'Vendor\GalleryController@video_store')->name('vendor-gallery-video-store');

  Route::post('/gallery/image/edit', 'Vendor\GalleryController@image_edit')->name('vendor-gallery-image-edit');
  Route::post('/gallery/video/edit', 'Vendor\GalleryController@video_edit')->name('vendor-gallery-video-edit');

  Route::get('/gallery/image/delete/{id}', 'Vendor\GalleryController@image_delete')->name('vendor-gallery-image-delete');
  Route::get('/gallery/video/delete/{id}', 'Vendor\GalleryController@video_delete')->name('vendor-gallery-video-delete');
  //GALLERY SECTION
...
Route::prefix('agent')->group(function() {
  ...
  // Vendor Dashboard
  Route::get('/dashboard', 'Agent\AgentController@index')->name('agent-dashboard');
  Route::get('/sellers', 'Agent\AgentController@sellers')->name('agent-sellers');
  Route::get('/sellers/datatables', 'Agent\AgentController@datatables')->name('agent-sellers-datatables');

  // Agent Profile
  Route::get('/profile', 'Agent\AgentController@profile')->name('agent-profile');
  Route::post('/profile', 'Agent\AgentController@profileupdate')->name('agent-profile-update');
  // Agent Profile Ends


  Route::get('/withdraw/datatables', 'Agent\WithdrawController@datatables')->name('agent-wt-datatables');
  Route::get('/withdraw', 'Agent\WithdrawController@index')->name('agent-wt-index');
  Route::get('/withdraw/create', 'Agent\WithdrawController@create')->name('agent-wt-create');
  Route::post('/withdraw/create', 'Agent\WithdrawController@store')->name('agent-wt-store');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/agents','Front\AgentController@index')->name('front.agent');
