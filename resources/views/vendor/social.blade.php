...
<div class="content-area">
            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              ...
              @include('includes.admin.form-both')  
                ...
                <div class="row">
                  <label class="control-label col-sm-3" for="twitter">Website *</label>
                  <div class="col-sm-6">
                    <input class="form-control" name="w_url" id="twitter" placeholder="Website" required="" type="text" value="{{$data->w_url}}">
                  </div>
                  <div class="col-sm-3">
                    <label class="switch">
