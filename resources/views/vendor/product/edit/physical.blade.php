                      ...
                      <li>
                        ...
                        @include('includes.vendor.form-both')
                                                ...
                                                <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">Minimum Order </h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="number" class="input-field" placeholder="Minimum number customer can order at a time" name="min_order" required="" value="{{ $data->min_order }}">
													</div>
												</div>
                                              ...
                                              @endforeach
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<select id="market_id" name="market_id" {{$data->subcategory_id == null ? "disabled":""}}>
															<option value="">{{ __('Select Market') }}</option>
															@if($data->market_id != null)
																@if( App\Market::find($data->market_id))
																
																	<option value="{{ App\Market::find($data->market_id)->id }}" selected>{{ App\Market::find($data->market_id)->name }}</option>
