											...
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ $langg->lang431 }}</h5>
															...
															<li>
																<a href="{{ route('agent-profile') }}"><i class="fas fa-user"></i> {{ $langg->lang434 }}</a>
															</li>
															<li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="{{ route('agent-dashboard') }}" class="wave-effect active"><i class="fa fa-home mr-2"></i>{{ $langg->lang441 }}</a>
							</li>

							<li>
								<a href="{{ route('agent-sellers') }}" class="wave-effect active"><i class="fa fa-home mr-2"></i>My Sellers</a>
							</li>

							<li>
								<a href="{{ route('agent-wt-index') }}" class=" wave-effect"><i class="fas fa-list"></i>{{ $langg->lang451 }}</a>
							</li>
