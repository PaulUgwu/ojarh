							...
							<div class="list">
								<ul>
									...
									@if($gs->reg_vendor == 1)
										<li>
                        				@if(Auth::check())
	                        				@if(Auth::guard('web')->user()->is_agent == 1)
	                        					<a href="{{ route('vendor-dashboard') }}" class="sell-btn">Agent</a>
	                        				@else
	                        					<a href="{{ route('user-package') }}" class="sell-btn">Agent</a>
	                        				@endif
										</li>
                        				@else
										<li>
											<a href="{{ route('user.login') }}" class="sell-btn">Agent</a>
										</li>
										@endif
									@endif
													...
													<div class="categorie_sub_menu">
														<ul>
															...
															<li><a href="{{ route('front.childcat',['slug1' => $childcat->subcategory->category->slug, 'slug2' => $childcat->subcategory->slug, 'slug3' => $childcat->slug]) }}">{{$childcat->name}}</a>
																@if(App\Market::where('child_category_id', $childcat->id)->get())
																	@foreach(App\Market::where('child_category_id', $childcat->id)->get() as $catt)
																		<ul class="ml-2">
																			<li><a href="{{ route('front.childcat',['slug1' => $childcat->subcategory->category->slug, 'slug2' => $childcat->subcategory->slug, 'slug3' => $childcat->slug]) }}">{{ $catt->name }} </a></li>
																		</ul>
																	@endforeach
																@endif
															</li>
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							<li><a href="{{ url('/vendors/africa') }}">African</a></li>
							<li><a href="{{ url('/vendors/foreign') }}">Foreign</a></li>
							<li>
				...
				<div class="col-md-5 col-lg-3">
					<div class="footer-widget info-link-widget">
						...
						<ul class="link-list">
							...
							<li>
								<a href="{{ route('front.page','tnc') }}">
									<i class="fas fa-angle-double-right"></i>Terms & Conditions
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','privacy_policies') }}">
							...
							<li>
								<a href="{{ route('front.page','severability') }}">
									<i class="fas fa-angle-double-right"></i>Severability
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','liability') }}">
									<i class="fas fa-angle-double-right"></i>Liabilities Of Parties
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','user_submission') }}">
									<i class="fas fa-angle-double-right"></i>User Submission
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','rule') }}">
									<i class="fas fa-angle-double-right"></i>Rules For Filling Comapny Information
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','account_information') }}">
									<i class="fas fa-angle-double-right"></i>Account Information
								</a>
							</li>
				...
				<div class="col-md-4 col-lg-3">
					<div class="footer-widget info-link-widget">
						...
						<ul class="link-list">
							...
							<li>
								<a href="{{ route('front.page','seller_rights') }}">
									<i class="fas fa-angle-double-right"></i>Seller's Right
								</a>
							</li>

							<li>
								<a href="{{ url('user/admin/disputes') }}">
									<i class="fas fa-angle-double-right"></i>Disputes Center
								</a>
							</li>
							...
							<li>
								<a href="javascript:void(Tawk_API.toggle())">
									<i class="fas fa-angle-double-right"></i>Live Chat
								</a>
							</li>

							<li>
								<a href="{{ url('agents') }}">
									<i class="fas fa-angle-double-right"></i>Agents
								</a>
							</li>


							<li>
								<a href="{{ route('front.page','display') }}">
									<i class="fas fa-angle-double-right"></i>Display Of Product & Company Images
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','sellers_information') }}">
									<i class="fas fa-angle-double-right"></i>Sellers Information For Setting Up Store
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','payment_options') }}">
									<i class="fas fa-angle-double-right"></i>Buyers Payment Options
								</a>
							</li>

							<li>
								<a href="{{ route('front.page','company_details') }}">
									<i class="fas fa-angle-double-right"></i>Company Details
								</a>
							</li>
...
<div class="form-input">
 ...
 <div class="form-input">
							   ...
							   <div class="col-lg-12">
												<div class="form-input">
													<input type="text" name="agent_ref_id" placeholder="Enter Agent Code">
