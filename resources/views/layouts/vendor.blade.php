				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="#gallery1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-video"></i>Gallery
								</a>
								<ul class="collapse list-unstyled" id="gallery1" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-gallery-image-index') }}"><span>Image</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-gallery-video-index') }}"><span>Video</span></a>
									</li>
								</ul>
							</li>

							<li>
								<a href="{{ url('vendor/chats') }}"><i class="fas fa-upload"></i>Chats</a>
							</li>
