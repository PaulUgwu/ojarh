										...
										<div class="order-area">
											...
											<div class="order-item">
												...
												<div class="product-content">
													...
													@if($product['qty'] < App\Models\Product::find($product['item']->id)->min_order)
														<div class="quantity text-danger">
															<h5 class="label text-danger">You need to order atleast {{ App\Models\Product::find($product['item']->id)->min_order }} of this product.</h5>
														</div>
														<?php $min_order_check = 1 ?>
													@endif
										...
										<div class="row">
											<div class="col-lg-12 mt-3">
												<div class="bottom-area">
													<a href="javascript:;" id="step1-btn"  class="mybtn1 mr-3">{{ $langg->lang757 }} {{ $min_order_check }}</a>
													
													
													@if($min_order_check === 0)
														<a href="javascript:;" id="step3-btn"  class="mybtn1">{{ $langg->lang753 }}</a>
													@else
														<a href="{{ url('/carts') }}"  class="mybtn1"> Back to cart</a>
													@endif
												</div>
											</div>
										</div>
