    ...
    <div class="row">
      <div class="col-lg-8">
                      ...
                      <td class="product-img">
                        <div class="item">
                          ...
                          <p class="name"><a href="{{ route('front.product', $product['item']['slug']) }}">{{strlen($product['item']['name']) > 35 ? substr($product['item']['name'],0,35).'...' : $product['item']['name']}}</a></p>
                              ...
                              <p class="name mt-0 text-danger"><small>Minimum Order: {{ App\Models\Product::find($product['item']->id)->min_order }}</small></p>
                              @endif
                        </div>
                      </td>
                                            <td>
        ...
        @endif
                      ...
                      <td>
                      @if($product['qty'] < App\Models\Product::find($product['item']->id)->min_order)
                          <p class="text-danger">{{ App\Models\Product::find($product['item']->id)->min_order }}</p>
                      @else
