			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 remove-padding d-none d-lg-block">
						<div class="aside">
							@if($adverts->where('position', 'long'))
								@foreach($adverts->where('position', 'long')->take(2) as $img)
									<a class="banner-effect mb-10" href="{{ $img->link }}">
										<img src="{{asset('storage/adverts/'.$img->image)}}" alt="">
									</a>
								@endforeach
							@endif
						</div>
	...
	@if($adverts->where('position', 'wide-big'))
		<!-- Banner Area One Start -->
		<section class="banner-section">
			<div class="container">
				@foreach($adverts->where('position', 'wide-big')->chunk(1) as $chunk)
					<div class="row">
						@foreach($chunk as $img)
							<div class="col-lg-12 remove-padding">
								<div class="img">
									<a class="banner-effect" href="{{ $img->link }}">
										<img height="400px" width="100%" src="{{asset('storage/adverts/'.$img->image)}}" alt="">
									</a>
								</div>
							</div>
						@endforeach
	...
	@if($adverts->where('position', 'long'))
		...
		<section class="banner-section">
			<div class="container">
				<div class="row">
					@foreach($adverts->where('position', 'long')->take(3) as $img)
