                  ...
                  <div class="contact-seller">
                    ...
                    <ul class="list">
                      ...
                      <li>
                        ...
                        <a  class="view-stor" href="javascript:;" id="addClass">
                          <i class="icofont-ui-chat"></i>
                          Chat Seller
                        </a>
                      </li>
...
<div style="z-index: 1000 !important;">
    ...
    <div class="popup-box chat-popup" id="qnimate"  style="z-index: 1000 !important;">
        <div class="popup-head"  style="z-index: 1000 !important;">
            <div class="popup-head-left pull-left"><img src="" alt="iamgurdeeposahan"> {{ $manufacturer->company_name ?? ''}}</div>
        ...
        <div class="direct-chat-messages" id="new_chat_form" >
            ...
            <form onsubmit="event.preventDefault(); create_message()">
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" value="{{ $productt->id }}" id="product_id">
                </div>
...
<script type="text/javascript">
  ...
  // chat start here
  // xcxcxcxcxcxcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
  $(function(){
  ...
  function continue_chat(){
      ...
      form.append("user_id", '{{ $productt->user_id }}');
