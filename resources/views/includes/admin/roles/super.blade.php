<li>
    ...
    <li>
        ...
        @endif" id="menu5" data-parent="#accordion" >
                ...
                <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='market') active @endif">
                    <a href="{{ route('admin-market-index') }}"><span>{{ __('Market') }}</span></a>
                </li>
        </ul>
    </li>

    <li>
        <a href="#agent" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-ui-user-group"></i>{{ __('Agents') }}
        </a>
        <ul class="collapse list-unstyled" id="agent" data-parent="#accordion">
            <li>
                <a href="{{ url('admin/agents') }}"><span>{{ __('Agents List') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-agent-withdraw-index') }}"><span>{{ __('Withdraws') }}</span></a>
            </li>
    ...
    <li>
        <a href="{{ route('admin-advert-index') }}" class=" wave-effect"><i class="fas fa-percentage"></i>{{ __('Advert') }}</a>
    </li>
