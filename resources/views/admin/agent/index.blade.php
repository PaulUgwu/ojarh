							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="javascript:;">{{ __("Agents") }}</a>
											</li>
											<li>
												<a href="{{ route('admin-agent-index') }}">{{ __("Agent List") }}</a>
											</li>
										</ul>
								</div>
							</div>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
		                                                  ...
		                                                  <th>{{ __("Agent Phone Number") }}</th>
		                                                  <th>{{ __("Agent Address") }}</th>
		                                                  <th>{{ __("Options") }}</th>
														</tr>
													</thead>
												</table>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-agent-datatables') }}',
               columns: [
                        { data: 'agent_name', name: 'agent_name' },
                        { data: 'email', name: 'email' },
                        { data: 'agent_phone_number', name: 'agent_phone_number' },
                        { data: 'agent_address', searchable: false, orderable: false},
