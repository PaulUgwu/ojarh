...
@section('content')
                        ...
                        <div class="content-area">
                         ...
                         <form id="geniusform" class="form-horizontal" action="{{route('agent-wt-store')}}" method="POST" enctype="multipart/form-data">

                                                    {{ csrf_field() }}


                                <div class="item form-group">
                                    <label class="control-label col-sm-4" for="name"><b>{{ $langg->lang498 }} : N{{ Auth::user()->agent_balance }}</b></label>
                                </div>
