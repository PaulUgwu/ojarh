...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::share('adverts', \App\Advert::where('ending_date', '!=', null)->where('ending_date', '>=', now())->inRandomOrder()->get());

        // $adverts = \App\Advert::where('ending_date', '!=', null)->where('ending_date', '>=', now())->inRandomOrder()->get();
