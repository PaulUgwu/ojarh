...
class VendorController extends Controller
{
    ...
    {
        $vendors = User::where('is_vendor', 2)->whereNotIn('country', ['Angola', 'Algeria', 'Argentina', 'Benin', 'Bermuda'])->paginate(12);
        return view('front.vendor_by_country', [
            'users' => $vendors
        ]);
    }
    ...
    {
        $vendors = User::where('is_vendor', 2)->whereIn('country', ['Angola', 'Algeria', 'Argentina', 'Benin', 'Bermuda'])->paginate(12);
        return view('front.vendor_by_country', [
            'users' => $vendors
        ]);
    }
